package com.sibo.common.utils.file;

import com.sibo.common.exception.file.FileNameLengthLimitExceededException;
...
public class FileUploadUtils {
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = SbConfig.getProfile();
